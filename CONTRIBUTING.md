...
Install the environment and build manuscript:
...
- `readme.md` contains the paper's revisions (completed and ongoing). Revision sheets are generated from this document.
...
```
Submitted [manuscript](YYYY-MM-DD-JOURNAL_Manuscript_ManuscriptID.pdf) and [revision sheet](YYYY-MM-DD-JOURNAL_Revision_sheet_ManuscriptID.pdf).
```
    - [ ] Create git-tag
- Analyses repository:
...
- Use revision-sheet-generator/generate_revision_sheet.py
- Check result
