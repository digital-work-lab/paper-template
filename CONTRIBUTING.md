...
- `output` contains all output, such as data plots and tables, which is generated by the scripts (**do not store anything else that is not generated by the scripts in this directory**)
...
Shared and symlinked directories (ignored in [git versioning](.gitignore)):
...
- Export manuscript as word file.
...
- [ ] Are your figures/tables self-contained?
You should be able to read the article without looking at the figures/tables and vice versa.
- Tables:
